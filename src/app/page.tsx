...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#F9FAFB] text-slate-900 font-sans relative overflow-x-hidden">
      ...
      {/* Left Side */}
      <div className="relative z-10 w-full md:w-1/2 flex flex-col p-6 md:p-16 justify-between">
        <div className="flex items-center gap-2 font-bold text-xl mb-8 md:mb-0">
        ...
        <div className="hidden md:flex gap-6 text-xs font-bold text-slate-400 tracking-wider uppercase">
        ...
        <div className="bg-white md:h-full md:w-full w-full max-w-md md:max-w-none rounded-3xl md:rounded-none shadow-xl md:shadow-none p-8 md:p-24 flex flex-col justify-center">
          <div className="w-full max-w-md mx-auto space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm"><span className="px-4 bg-white text-slate-400 uppercase tracking-widest text-xs">Or with email</span></div>
            </div>
